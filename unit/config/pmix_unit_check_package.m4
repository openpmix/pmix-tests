...
AC_DEFUN([_PMIXUNIT_CHECK_PACKAGE_HEADER], [
    ...
    AS_VAR_PUSHDEF([pmix_unit_Header], [ac_cv_header_$2])
    ...
    # again...
    unset pmix_unit_Header
    pmix_unit_check_package_header_happy="no"
    ...
    AS_IF([test "$hdir_prefix" = "" || \
           ...
           [ # try as is...
            ...
            AC_CHECK_HEADERS([$2], [pmix_unit_check_package_header_happy="yes"], [])
            AS_IF([test "$pmix_unit_check_package_header_happy" = "no"],
    ...
    AS_IF([test "$pmix_unit_check_package_header_happy" = "no"],
          [AS_IF([test "$hdir_prefix" != ""],
                 [$1_CPPFLAGS="$$1_CPPFLAGS -I$hdir_prefix"
                  ...
                  AC_CHECK_HEADERS([$2], [pmix_unit_check_package_header_happy="yes"], [], [$6])
                  AS_IF([test "$pmix_unit_check_package_header_happy" = "no"],
                        [unset pmix_unit_Header
    ...
    AS_IF([test "$pmix_unit_check_package_header_happy" = "yes"],
          [$4], [$5])

    unset pmix_unit_check_package_header_happy

    AS_VAR_POPDEF([pmix_unit_Header])dnl
])
...
AC_DEFUN([_PMIXUNIT_CHECK_PACKAGE_LIB], [
    ...
    # code into other places unless you want much pain and suffering
    AS_LITERAL_IF([$2],
                  [AS_VAR_PUSHDEF([pmix_unit_Lib], [ac_cv_lib_$2_$3])],
                  [AS_VAR_PUSHDEF([pmix_unit_Lib], [ac_cv_lib_$2''_$3])])dnl

    # see comment above
    unset pmix_unit_Lib
    pmix_unit_check_package_lib_happy="no"
    ...
    AS_IF([test "$libdir_prefix" != ""],
          [# libdir was specified - search only there
           ...
           AC_SEARCH_LIBS([$3], [$2],
                        [pmix_unit_check_package_lib_happy="yes"],
                        [pmix_unit_check_package_lib_happy="no"], [$4])
           AS_IF([test "$pmix_unit_check_package_lib_happy" = "no"],
                 [LDFLAGS="$pmix_unit_check_package_$1_save_LDFLAGS"
                  $1_LDFLAGS="$pmix_unit_check_package_$1_orig_LDFLAGS"
                  unset pmix_unit_Lib])],
    ...
    AS_IF([test "$pmix_unit_check_package_lib_happy" = "yes"],
          [$1_LIBS="-l$2 $4"
           $7], [$8])
    AS_IF([test "$pmix_unit_check_package_lib_happy" = "yes"],
    ...
    AS_VAR_POPDEF([pmix_unit_Lib])dnl
])
...
AC_DEFUN([PMIXUNIT_CHECK_PACKAGE],[
    ...
    pmix_unit_check_package_$1_orig_CPPFLAGS="$$1_CPPFLAGS"
    ...
    AS_IF([test "$pmix_unit_check_package_happy" = "yes"],
          [$8],
          [$1_CPPFLAGS="$pmix_unit_check_package_$1_orig_CPPFLAGS"
           $1_LDFLAGS="$pmix_unit_check_package_$1_orig_LDFLAGS"
           $1_LIBS="$pmix_unit_check_package_$1_orig_LIBS"
           $9])

    CPPFLAGS="$pmix_unit_check_package_$1_save_CPPFLAGS"
    LDFLAGS="$pmix_unit_check_package_$1_save_LDFLAGS"
    LIBS="$pmix_unit_check_package_$1_save_LIBS"
])
